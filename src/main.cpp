...
int main(int, char**)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // update settings window
        {
            ...
            ImGui::SliderFloat("Barrier width", &arkanoid_settings.barrier_width, ArkanoidSettings::barrier_width_min, ArkanoidSettings::barrier_width_max);
            ImGui::SliderInt("Wall count", &arkanoid_settings.walls_count, ArkanoidSettings::walls_min, ArkanoidSettings::walls_max);
            ...
            ImGui::Spacing();
            ImGui::SliderFloat("Carriage width", &arkanoid_settings.carriage_width, ArkanoidSettings::carriage_width_min, arkanoid_settings.world_size.x *0.98f);
